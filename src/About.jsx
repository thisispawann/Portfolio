    ...
    return (
      <>
        <section id="header" className="wrapper">
          ...
          <p className="p-wrapper mt-4" style={{ textAlign: "justify" }}>
            I am a passionate software engineer who has an extensive background in various coding languages,
            developing web applications, and building websites from the scratch.
            Currently, he is doing BTEC HND in Computing at International School
            of Management and Technology. I enjoy creating simple, clean, and
            creative user interfaces using the latest technologies. I
            specialized in Java, Spring Boot, Python along with a modern
            JavaScript library like React.
          </p>
          <div className="pt-2 mt-5 p-wrapper">
            <h4 className="skills">Skills:</h4>
            <p>
              <strong>Languages:</strong> JavaScript (ES5. ES6+), HTML5, CSS
              (CSS3), MySQL, Python, Java
            </p>
            <p>
              <strong>Frameworks/Libraries:</strong> Python, Spring Boot,
              Microservices, React.js, Gatsby.js, Redux, Material UI,
              Styled-Components, yarn, npm, babel
            </p>
            <p>
              <strong>Version control:</strong> Git, Bitbucket, CI/CD
            </p>
